...
- `bonfire_list_organizations` — curated live-verified 195-org US seed directory of governments on **Bonfire (Euna)** (filter `state`/`query`); feed a result's `org` to the next tool.
