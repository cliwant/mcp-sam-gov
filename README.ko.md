...
- **주·지방 오픈데이터 지도**: `skills/sam-gov/SKILL.md`에 주별 검증된 데이터셋 ID·행 수·주의사항이 담긴 조회 표가 있습니다(VA eVA 169만 건·MA CTHRU ~4,900만 건·NJ 66만 건·NY 28만 건·WA 32만 건 등). 이들은 각 주의 공식 입찰 포털이 아닌 공개 데이터 미러이며, CA·TX·OH·NC·MI 등의 공식 포털은 로그인·WAF 차단으로 키 없이 접근 불가입니다.
