...
1. [최신 release](https://github.com/cliwant/govicon-mcp-sam-gov/releases/latest) 에서 **`govicon-mcp-sam-gov.mcpb`** 다운로드.
...
설치 후 `govicon-mcp-sam-gov` 가 PATH 등록됨. 호스트 config 에 추가:
...
전체 도구 목록 + 입력 schema 는 영문 README 의 collapsible 섹션 참조: https://github.com/cliwant/govicon-mcp-sam-gov#tool-catalog-36-tools
