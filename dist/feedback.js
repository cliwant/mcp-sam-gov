 ...
 */
export function reportUrlForError(tool, kind, version) {
    const title = `[${tool}] ${kind}`;
    const kindHint = kind === "schema_drift"
 ...
 */
export const REPORTABLE_ERROR_KINDS = new Set([
    "schema_drift",
 ...
 */
export function maybeAttachReport(error, tool, version) {
