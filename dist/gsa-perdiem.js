...
const FISCAL_YEAR_NOTE = "fiscalYear (= year) is the U.S. FEDERAL FISCAL YEAR (Oct 1–Sep 30). " +
...
export async function perdiemRates(args) {
    ...
    const notes = [RATE_MEANING_NOTE, STANDARD_RATE_NOTE, NO_PAGINATION_NOTE, FISCAL_YEAR_NOTE];
    if (yearWasDefaulted) {
