...
1. [最新リリース](https://github.com/cliwant/govicon-mcp-sam-gov/releases/latest) から **`govicon-mcp-sam-gov.mcpb`** をダウンロード。
...
インストール後 `govicon-mcp-sam-gov` が PATH に登録される。ホスト config に追加：
...
全ツール一覧 + 入力 schema は英語 README の collapsible セクション参照：https://github.com/cliwant/govicon-mcp-sam-gov#tool-catalog-36-tools
